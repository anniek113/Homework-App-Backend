...
//       "CREATE TABLE IF NOT EXISTS student (id INT UNIQUE NOT NULL AUTO_INCREMENT, username VARCHAR(255), skype VARCHAR(255), bio VARCHAR (4095), birthday VARCHAR(10), profilepic VARCHAR(255), PRIMARY KEY(id), FOREIGN KEY(username) REFERENCES user(username))"
//     );
...
//       "CREATE TABLE IF NOT EXISTS teacher (id INT UNIQUE NOT NULL AUTO_INCREMENT, username VARCHAR(255), subject VARCHAR(255), experience VARCHAR(255), method VARCHAR(255), price VARCHAR(255), skype VARCHAR(255), bio VARCHAR (4095), birthday VARCHAR(10), profilepic VARCHAR(255), PRIMARY KEY(id), FOREIGN KEY(username) REFERENCES user(username) )"
//     );
